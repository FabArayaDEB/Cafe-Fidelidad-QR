...
public class TableroEntity {
    ...
    public int getVisitasMesActual() { return visitasMesActual; }
    public void setVisitasMesActual(int visitasMesActual) { this.visitasMesActual = visitasMesActual; }
    
    public int getVisitasSemanaActual() { return visitasSemanaActual; }
    public void setVisitasSemanaActual(int visitasSemanaActual) { this.visitasSemanaActual = visitasSemanaActual; }
    ...
    public Long getSucursalFavoritaId() { return sucursalFavoritaId; }
    public void setSucursalFavoritaId(Long sucursalFavoritaId) { this.sucursalFavoritaId = sucursalFavoritaId; }
    
    public String getSucursalFavoritaNombre() { return sucursalFavoritaNombre; }
    public void setSucursalFavoritaNombre(String sucursalFavoritaNombre) { this.sucursalFavoritaNombre = sucursalFavoritaNombre; }
    ...
    public int getBeneficiosCanjeables() { return beneficiosCanjeables; }
    public void setBeneficiosCanjeables(int beneficiosCanjeables) { this.beneficiosCanjeables = beneficiosCanjeables; }
    
    public int getTotalCanjes() { return totalCanjes; }
    public void setTotalCanjes(int totalCanjes) { this.totalCanjes = totalCanjes; }
    
    public int getCanjesMesActual() { return canjesMesActual; }
    public void setCanjesMesActual(int canjesMesActual) { this.canjesMesActual = canjesMesActual; }
    
    public Date getUltimoCanjeFecha() { return ultimoCanjeFecha; }
    public void setUltimoCanjeFecha(Date ultimoCanjeFecha) { this.ultimoCanjeFecha = ultimoCanjeFecha; }
    
    public String getUltimoCanjeBeneficio() { return ultimoCanjeBeneficio; }
    public void setUltimoCanjeBeneficio(String ultimoCanjeBeneficio) { this.ultimoCanjeBeneficio = ultimoCanjeBeneficio; }
    ...
    public int getPuntosSiguienteNivel() { return puntosSiguienteNivel; }
    public void setPuntosSiguienteNivel(int puntosSiguienteNivel) { this.puntosSiguienteNivel = puntosSiguienteNivel; }
    
    public double getProgresoNivel() { return progresoNivel; }
    public void setProgresoNivel(double progresoNivel) { this.progresoNivel = progresoNivel; }
    
    public int getRachaVisitas() { return rachaVisitas; }
    public void setRachaVisitas(int rachaVisitas) { this.rachaVisitas = rachaVisitas; }
    
    public int getMetaVisitasMes() { return metaVisitasMes; }
    public void setMetaVisitasMes(int metaVisitasMes) { this.metaVisitasMes = metaVisitasMes; }
    
    public double getProgresoMetaVisitas() { return progresoMetaVisitas; }
    public void setProgresoMetaVisitas(double progresoMetaVisitas) { this.progresoMetaVisitas = progresoMetaVisitas; }
    
    public String getBeneficioRecomendadoId() { return beneficioRecomendadoId; }
    public void setBeneficioRecomendadoId(String beneficioRecomendadoId) { this.beneficioRecomendadoId = beneficioRecomendadoId; }
    
    public String getBeneficioRecomendadoNombre() { return beneficioRecomendadoNombre; }
    public void setBeneficioRecomendadoNombre(String beneficioRecomendadoNombre) { this.beneficioRecomendadoNombre = beneficioRecomendadoNombre; }
    
    public int getBeneficioRecomendadoPuntos() { return beneficioRecomendadoPuntos; }
    public void setBeneficioRecomendadoPuntos(int beneficioRecomendadoPuntos) { this.beneficioRecomendadoPuntos = beneficioRecomendadoPuntos; }
    
    public Long getSucursalRecomendadaId() { return sucursalRecomendadaId; }
    public void setSucursalRecomendadaId(Long sucursalRecomendadaId) { this.sucursalRecomendadaId = sucursalRecomendadaId; }
    
    public String getSucursalRecomendadaNombre() { return sucursalRecomendadaNombre; }
    public void setSucursalRecomendadaNombre(String sucursalRecomendadaNombre) { this.sucursalRecomendadaNombre = sucursalRecomendadaNombre; }
    ...
    public boolean isCacheValido() { return cacheValido; }
    public void setCacheValido(boolean cacheValido) { this.cacheValido = cacheValido; }
    
    public Date getFechaExpiracionCache() { return fechaExpiracionCache; }
    public void setFechaExpiracionCache(Date fechaExpiracionCache) { this.fechaExpiracionCache = fechaExpiracionCache; }
    ...
    public void actualizarCache() {
        this.cacheValido = true;
        this.fechaExpiracionCache = new Date(System.currentTimeMillis() + (60 * 60 * 1000)); // 1 hora
    }
    
    public boolean esCacheExpirado() {
        return !cacheValido || fechaExpiracionCache.before(new Date());
    }
    ...
    public boolean puedeCanjeaBeneficioRecomendado() {
        return beneficioRecomendadoPuntos > 0 && puntosDisponibles >= beneficioRecomendadoPuntos;
    }
    
    public int getDiasDesdeUltimaVisita() {
        if (ultimaVisita == null) return -1;
        long diferencia = new Date().getTime() - ultimaVisita.getTime();
        return (int) (diferencia / (24 * 60 * 60 * 1000));
    }
    
    public boolean esClienteActivo() {
        return getDiasDesdeUltimaVisita() <= 30; // Activo si visitó en los últimos 30 días
    }
    ...
    public String getEstadoProgreso() {
        ...
        if (progresoNivel >= 20) return "Progreso inicial";
        return "Recién comenzando";
    }
    
    public String getMensajeMotivacional() {
        if (rachaVisitas >= 7) return "¡Excelente racha de visitas!";
        if (rachaVisitas >= 3) return "¡Mantén el ritmo!";
        if (puedeCanjeaBeneficioRecomendado()) return "¡Tienes puntos para canjear!";
