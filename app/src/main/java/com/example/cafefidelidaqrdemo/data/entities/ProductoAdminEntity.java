 ...
 */
@Entity(tableName = "productos_admin")
public class ProductoAdminEntity {
    ...
    public ProductoAdminEntity(String nombre, String descripcion, double precio, 
    ...
    public boolean equals(Object o) {
        ...
        ProductoAdminEntity that = (ProductoAdminEntity) o;
        return id == that.id;
    }
