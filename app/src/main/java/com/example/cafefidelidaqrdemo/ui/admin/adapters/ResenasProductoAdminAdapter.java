...
public class ResenasProductoAdminAdapter extends RecyclerView.Adapter<ResenasProductoAdminAdapter.ViewHolder> {

    private List<ResenaProducto> data;
    private final SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy HH:mm", Locale.getDefault());
    private java.util.Map<Integer, String> userNames = new java.util.HashMap<>();
    private String productoNombre = "";

    public ResenasProductoAdminAdapter(List<ResenaProducto> data) {
        this.data = data;
    }

    public void updateData(List<ResenaProducto> newData) {
        this.data = newData;
    ...
    public void setProductoNombre(String nombre) {
        this.productoNombre = nombre != null ? nombre : "";
        notifyDataSetChanged();
    }
