...
// FIREBASE Y GOOGLE SIGN IN COMENTADO - Usando autenticación local
...
public class OpcionesLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // FIREBASE COMENTADO - Usando autenticación local
        ...
        // GOOGLE SIGN IN COMENTADO - Usando autenticación local
        ...
        binding.typeGoogle.setOnClickListener(v -> {
            // GOOGLE SIGN IN COMENTADO - Mostrando credenciales locales
            // signInWithGoogle();
            showLocalCredentials();
        });
    }

    // MÉTODO GOOGLE SIGN IN COMENTADO
    ...
    // NUEVO MÉTODO PARA MOSTRAR CREDENCIALES LOCALES
    private void showLocalCredentials() {
        String credentials = authRepository.getAvailableCredentials();
        
        new AlertDialog.Builder(this)
                .setTitle("Credenciales Locales Disponibles")
                .setMessage(credentials)
                .setPositiveButton("Entendido", null)
                .show();
    }

    // MÉTODO onActivityResult COMENTADO - Ya no se usa Google Sign In
    // @Override
    ...
    // MÉTODO firebaseAuthWithGoogle COMENTADO
    ...
    // MÉTODO checkUserExistsInDatabase COMENTADO
    ...
    //                                     SessionManager sessionManager = new SessionManager(OpcionesLoginActivity.this);
    //                                     String userId = (String) existingUserData.get("uid");
    //                                     String email = (String) existingUserData.get("email");
    //                                     String name = (String) existingUserData.get("names");
    ...
    // MÉTODO createUserDataForGoogleSignIn COMENTADO
    ...
    //                                 String name = (String) userData.get("names");
    //                                 sessionManager.createSession(userId, email, name);
    //                                 
    //                                 progressDialog.dismiss();
    //                                 Toast.makeText(OpcionesLoginActivity.this, 
