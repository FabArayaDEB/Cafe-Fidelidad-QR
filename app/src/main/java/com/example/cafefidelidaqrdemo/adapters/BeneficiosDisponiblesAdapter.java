    ...
    class BeneficioViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(BeneficioEntity beneficio) {
            ...
            textDescripcion.setText(beneficio.getNombre() != null ?
                    beneficio.getNombre() : "Beneficio disponible para usar");
        ...
        private int getTipoIcon(String tipo) {
            if (tipo == null) return R.drawable.ic_redeem;
            switch (tipo.toUpperCase()) {
                case "DESCUENTO_PORCENTAJE":
                case "DESCUENTO_MONTO":
        ...
        private int getTipoColor(String tipo) {
            if (tipo == null) return R.color.color_primary;
            switch (tipo.toUpperCase()) {
                case "DESCUENTO_PORCENTAJE":
